      ...
      <div className="bg-white dark:bg-choco-800 rounded-2xl shadow-xl p-8 w-full max-w-sm border border-choco-100 dark:border-choco-700">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-choco-600 hover:bg-choco-700 dark:bg-choco-500 dark:hover:bg-choco-400 text-white font-semibold rounded-xl py-2.5 text-sm transition disabled:opacity-60 mt-2 flex items-center justify-center gap-2"
          >
            {loading && (
